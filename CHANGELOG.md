...
All notable changes to the Varbase Workflow Base recipe are documented in this file.
...
### Changed
- Update Drupal Core from ~11.3.0 to ~11.4.0 in the Varbase Workflow Base recipe.
...
### Changed
- Maintenance and dependency updates for the Varbase Workflow Base recipe.

## [1.0.0-alpha1]
### Added
- Initial release of the Varbase Workflow Base recipe.

[Unreleased]: https://git.drupalcode.org/project/varbase_workflow_base/-/compare/1.0.0-beta1...1.0.x
...
[1.0.0-alpha1]: https://git.drupalcode.org/project/varbase_workflow_base/-/tags/1.0.0-alpha1
